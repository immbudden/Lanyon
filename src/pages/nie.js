...
const CaseStudyStatSports = (props) => (
    ...
    <div>
        ...
        <NavMobile />
        <Helmet
            title='NIE Networks | Lanyon'
            meta={[
                { name: 'description', content: 'Lanyon worked with NIE Networks to develop and deliver a multi-disciplinary internal communications strategy' },
                { name: 'keywords', content: 'communications, reputation, NIE, stakeholder, belfast, employee, engagement, media, design, video' },
            ]}
        >
          <html lang="en" />
        </Helmet>
