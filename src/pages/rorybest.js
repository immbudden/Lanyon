...
const CaseStudyStatSports = (props) => (
    ...
    <div>
        ...
        <NavMobile />
        <Helmet
            title='Rory Best | Lanyon'
            meta={[
                { name: 'description', content: 'Lanyon worked with Armagh, Banbridge & Craigavon council to maximise media coverage of Rory Best’s Freedom of the Borough' },
