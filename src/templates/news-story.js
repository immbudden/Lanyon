...
const NewsStory = (props) => {
  ...
  const body = props.data.prismicNewsStory.data.body.reduce(
    (object, item) => ({
      ...object,
  ...
  const headline_image =
    props.data.prismicNewsStory.data.headline_image.localFile.childImageSharp
      .fluid;
  const featured_image = get(
    body,
  ...
  const category =
    props.data.prismicNewsStory.data.category.document[0].data.category.text;
  const author =
    props.data.prismicNewsStory.data.author.document[0].data.author_name.text;
  ...
  return (
    <div>
      ...
      >
        ...
        <meta
          property="og:image"
          content={`${rootUrl}${props.data.prismicNewsStory.data.headline_image.localFile.childImageSharp.fluid.src}`}
        />
                ...
                {featured_image && (
                  <FeaturedImageWrapper>
                    ...
                    <FeaturedImageCaption>
                      {body.PrismicNewsStoryBodyFeaturedImage.image_caption}
                    </FeaturedImageCaption>
                  </FeaturedImageWrapper>
                )}
              </NewsStoryTextContainer>
            ...
            {body.PrismicNewsStoryBodyQuote ? (
              <QuoteContainer>
                <Quote>
                  ...
                  <QuoteText>
                    {body.PrismicNewsStoryBodyQuote.quote.text}
                  </QuoteText>
                  <QuoteBy>
                    {body.PrismicNewsStoryBodyQuote.quote_by.text}
                  </QuoteBy>
