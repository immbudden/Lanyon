...
const PostSlices = (props,{slices}) => {

    const body = props.data.prismicCaseStudy.data.body.reduce((object, item) => ({
        ...object,
    ...
    // Featured People
    const featured_person_1_name = get(body, "PrismicCaseStudyBodyFeaturedPeople.featured_person_1_name.text", null)
    const featured_person_1_title = get(body, "PrismicCaseStudyBodyFeaturedPeople.featured_person_1_title.text", null)
    const featured_person_1_image = get(body, "PrismicCaseStudyBodyFeaturedPeople.featured_person_1_image.localFile.childImageSharp.fluid", null)
    const featured_person_2_name = get(body, "PrismicCaseStudyBodyFeaturedPeople.featured_person_2_name.text", null)
    const featured_person_2_title = get(body, "PrismicCaseStudyBodyFeaturedPeople.featured_person_2_title.text", null)
    const featured_person_2_image = get(body, "PrismicCaseStudyBodyFeaturedPeople.featured_person_2_image.localFile.childImageSharp.fluid", null)
    const featured_person_3_name = get(body, "PrismicCaseStudyBodyFeaturedPeople.featured_person_3_name.text", null)
    const featured_person_3_title = get(body, "PrismicCaseStudyBodyFeaturedPeople.featured_person_3_title.text", null)
    const featured_person_3_image = get(body, "PrismicCaseStudyBodyFeaturedPeople.featured_person_3_image.localFile.childImageSharp.fluid", null)
    const featured_person_4_name = get(body, "PrismicCaseStudyBodyFeaturedPeople.featured_person_4_name.text", null)
    const featured_person_4_title = get(body, "PrismicCaseStudyBodyFeaturedPeople.featured_person_4_title.text", null)
    const featured_person_4_image = get(body, "PrismicCaseStudyBodyFeaturedPeople.featured_person_4_image.localFile.childImageSharp.fluid", null)
    

    // Image Section
    const section_image = get(body, "PrismicCaseStudyBodySectionImage.section_image.localFile.childImageSharp.fluid", null)

    // Title and Text Section
    const section_title = get(body, "PrismicCaseStudyBodySectionTitleText.section_title.text", null)
    const section_text = get(body, "PrismicCaseStudyBodySectionTitleText.section_text.html", null)
...
const CaseStudy = (props) => { 
    ...
    const slices = props.data.prismicCaseStudy.data.body;
